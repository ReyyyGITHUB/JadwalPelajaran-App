        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-16">
            <button 
              ...
              className="relative overflow-hidden bg-gradient-to-r from-emerald-500/20 to-teal-500/20 flex-1 text-left px-8 py-4 rounded-2xl border border-emerald-500/30 backdrop-blur-sm active:from-emerald-500/30 active:to-teal-500/30"
            >
              <div className="flex items-center justify-between">
            ...
            <button 
              onClick={handleShowJadwal}
              className="relative overflow-hidden bg-gradient-to-r from-emerald-500 to-teal-500 px-8 py-4 rounded-2xl shadow-lg min-w-fit active:from-emerald-600 active:to-teal-600"
            >
              <div className="flex items-center justify-center gap-2">
